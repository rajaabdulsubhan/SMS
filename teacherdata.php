...
<h1 class="text-center text-dark">Teachers Information</h1>
...
$q = "SELECT * FROM users Where status='teacher'";
...
<td>
<button class="btn btn-success"><a  href="updateteacher.php?Id=<?php echo $result['Id']; ?>" class="text-white text-decoration-none"> Edit </a> </button>
